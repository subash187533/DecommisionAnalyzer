(function (g) {
  ...
  function w(a) {
    q === p &&
      (q =
        -1 ===
        u
          .serializeToString(g.parseXML(o["xl/worksheets/sheet1.xml"]))
          .indexOf("xmlns:r"));
    g.each(a, function (b, d) {
      if (g.isPlainObject(d)) w(d);
      else {
        if (q) {
          ...
          for (e = c.attributes.length - 1; 0 <= e; e--) {
            ...
            -1 !== f.indexOf(":") &&
              (i.push({ name: f, value: k }), c.removeAttribute(f));
          }
          e = 0;
          for (f = i.length; e < f; e++)
            (k = d.createAttribute(
              i[e].name.replace(":", "_dt_b_namespace_token_")
            )),
              (k.value = i[e].value),
        ...
        q &&
          (-1 === c.indexOf("<?xml") &&
            (c = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>' + c),
  ...
  i.Client.prototype = {
    ...
    glue: function (a, b) {
      ...
      this.domElement &&
        ...
        (this.div.innerHTML = this.getHTML(c.width, c.height).replace(
          /&/g,
          "&amp;"
        )));
    },
  ...
  var x = function (a, b) {
    ...
    z = function (a, b) {
      for (
        var d = y(b),
          ...
          f = b.fieldSeparator,
          g = RegExp(e, "g"),
          i = b.escapeChar !== p ? b.escapeChar : "\\",
          j = function (a) {
            for (var b = "", c = 0, d = a.length; c < d; c++)
              0 < c && (b += f),
                (b += e ? e + ("" + a[c]).replace(g, i + e) + e : a[c]);
            return b;
          },
          l = b.header ? j(c.header) + d : "",
          D = b.footer && c.footer ? d + j(c.footer) : "",
          m = [],
          n = 0,
          h = c.body.length;
        n < h;
        ...
        m.push(j(c.body[n]));
      return { str: l + m.join(d) + D, rows: m.length };
    },
    t = {
      available: function () {
        return i.hasFlash();
    ...
    u = "",
    u =
      "undefined" === typeof j.XMLSerializer
        ? new (function () {
  ...
  h.ext.buttons.excelFlash = g.extend({}, t, {
    ...
    action: function (a, b, d, c) {
      ...
      var a = c._flash,
        e = 0,
        f = g.parseXML(o["xl/worksheets/sheet1.xml"]),
        i = f.getElementsByTagName("sheetData")[0],
        d = {
          _rels: { ".rels": g.parseXML(o["_rels/.rels"]) },
          xl: {
            _rels: {
              "workbook.xml.rels": g.parseXML(o["xl/_rels/workbook.xml.rels"]),
            },
            "workbook.xml": g.parseXML(o["xl/workbook.xml"]),
            "styles.xml": g.parseXML(o["xl/styles.xml"]),
            worksheets: { "sheet1.xml": f },
          },
          "[Content_Types].xml": g.parseXML(o["[Content_Types].xml"]),
        },
          ...
          for (var b = 0, c = a.length; b < c; b++) {
            ...
            if (!(null === a[b] || a[b] === p || "" === a[b])) {
              ...
              for (var k = 0, m = A.length; k < m; k++) {
                var o = A[k];
                if (a[b].match && !a[b].match(/^0\d+/) && a[b].match(o.match)) {
                  h = a[b].replace(/[^\d\.\-]/g, "");
                  o.fmt && (h = o.fmt(h));
                  h = n(f, "c", {
                    attr: { r: d, s: o.style },
                    children: [n(f, "v", { text: h })],
                  });
                  break;
                }
              }
              h ||
                ...
                (a[b].match &&
                  ...
                  : ((o = !a[b].replace
                    ...
                    (h = n(f, "c", {
                      attr: { t: "inlineStr", r: d },
                      children: {
                        row: n(f, "is", {
                          children: { row: n(f, "t", { text: o }) },
                        }),
                      },
                    }))));
              l.appendChild(h);
      ...
      var m = function (a, b) {
          ...
          c.append('<mergeCell ref="A' + a + ":" + v(b) + a + '" />');
          c.attr("count", c.attr("count") + 1);
          g("row:eq(" + (a - 1) + ") c", f).attr("s", "51");
        },
        b = b.buttons.exportInfo(c);
      b.title && (h([b.title], e), m(e, k.header.length - 1));
      b.messageTop && (h([b.messageTop], e), m(e, k.header.length - 1));
      c.header && (h(k.header, e), g("row:last c", f).attr("s", "2"));
      for (var r = 0, q = k.body.length; r < q; r++) h(k.body[r], e);
      c.footer &&
        k.footer &&
        (h(k.footer, e), g("row:last c", f).attr("s", "2"));
      b.messageBottom && (h([b.messageBottom], e), m(e, k.header.length - 1));
      h = n(f, "cols");
      g("worksheet", f).prepend(h);
      m = 0;
      for (r = k.header.length; m < r; m++)
        h.appendChild(
          n(f, "col", {
            attr: { min: m + 1, max: m + 1, width: B(k, m), customWidth: 1 },
          })
        );
  ...
  h.ext.buttons.pdfFlash = g.extend({}, t, {
