(function (j) {
  "function" === typeof define && define.amd
    ...
    ? (module.exports = function (k, l, t, s) {
        k || (k = window);
  ...
  function y(a, c) {
    u === q &&
      (u =
        -1 ===
        w
          .serializeToString(j.parseXML(z["xl/worksheets/sheet1.xml"]))
          .indexOf("xmlns:r"));
      ...
      if (j.isPlainObject(b)) {
        ...
        if (u) {
          ...
          for (f = e.attributes.length - 1; 0 <= f; f--) {
            ...
            -1 !== g.indexOf(":") &&
              (n.push({ name: g, value: h }), e.removeAttribute(g));
          }
          f = 0;
          for (g = n.length; f < g; f++)
            (h = b.createAttribute(
              n[f].name.replace(":", "_dt_b_namespace_token_")
            )),
              (h.value = n[f].value),
        ...
        u &&
          (-1 === e.indexOf("<?xml") &&
            (e = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>' + e),
  ...
  function p(a, c, d) {
    ...
    d &&
      (d.attr && j(b).attr(d.attr),
      d.children &&
        j.each(d.children, function (a, c) {
          b.appendChild(c);
        }),
      null !== d.text &&
        d.text !== q &&
    ...
    G = function (a, c) {
      for (
        var d = F(c),
          ...
          f = c.fieldSeparator,
          g = RegExp(e, "g"),
          n = c.escapeChar !== q ? c.escapeChar : "\\",
          j = function (a) {
            for (var b = "", c = 0, d = a.length; c < d; c++)
              0 < c && (b += f),
                (b += e ? e + ("" + a[c]).replace(g, n + e) + e : a[c]);
            return b;
          },
          h = c.header ? j(b.header) + d : "",
          k = c.footer && b.footer ? d + j(b.footer) : "",
          l = [],
          o = 0,
          i = b.body.length;
        o < i;
  ...
  m.ext.buttons.excelHtml5 = {
    ...
    action: function (a, c, d, b) {
      ...
      var m = function (a, b) {
          ...
          c.append('<mergeCell ref="A' + a + ":" + x(b) + a + '" />');
      ...
      b.footer &&
        d.footer &&
        (i(d.footer, f), j("row:last c", g).attr("s", "2"));
      o.messageBottom && (i([o.messageBottom], f), m(f, d.header.length - 1));
      c = p(g, "cols");
      j("worksheet", g).prepend(c);
      i = 0;
      for (m = d.header.length; i < m; i++)
        c.appendChild(
          p(g, "col", {
            attr: { min: i + 1, max: i + 1, width: J(d, i), customWidth: 1 },
          })
        );
  ...
  m.ext.buttons.pdfHtml5 = {
    ...
    action: function (a, c, d, b) {
      ...
      for (var g = 0, d = a.body.length; g < d; g++)
        c.push(
          j.map(a.body[g], function (a) {
            return {
              text: "string" === typeof a ? a : a + "",
      ...
      "open" === b.download && !H()
        ? (c.open(), this.processing(!1))
        : c.getBuffer(function (a) {
