...
$collection = $db->portability_metrics;
$inboundCol = $db->inbound_interfaces;
$outboundCol = $db->outbound_interfaces;
$lobs = $collection->distinct("LOB");

$totalApplications = $collection->count();
$lowPortable = $collection->find(array("portabilityindex" => array('$gt' => 0, '$lte' => 0.4)))->count();
$mediumPortable = $collection->find(array("portabilityindex" => array('$gt' => 0.4, '$lte' => 0.8)))->count();
$highPortable = $collection->find(array("portabilityindex" => array('$gt' => 0.8, '$lte' => 1)))->count();

// echo $lowPortable. "Low Portable";
...
<head>
    ...
    <title>Decommission Analyzer - Portability Metrics</title>
...
<body id="page-top">
                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Application With Portability Metrics
                                    </h6>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-6">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Inbound Interfaces</h6>
                        ...
                        <div class="col-xl-6 col-lg-6">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Outbound Interfaces</h6>

                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-striped" id="outboundTable"
                                            width="100%" cellspacing="0">
                                            <thead>
                                                <tr>
                                                    <?php 
                                                    $header = $outboundCol->findOne();
                                                    foreach($header as $key=>$value) {
                                                        if($key == '_id') continue;
                                                        echo "<th>". $key. "</th>";
                                                    }
        ...
        "dataProvider": [
            <?php 
                ...
                foreach($results as $result) {
                    ...
                    echo '"Portability Index":'. $result["portabilityindex"]. ',';
                    echo '"technical":'. $result["cyclomaticscore"]. ',';
                    echo '"maintainabilityindex":'. $result["maintainabilityindex"]. ',';
                    echo '"appsizevalue":'. $result["appsizevalue"]. ',';
                    echo '"outbound":'. $result["outbounds"]. ',';
                    echo '"inbound":'. $result["inbounds"]. ',';
                    echo '"appcriticality":'. $result["appcriticality"]. ',';
                    echo '"languagecomplexityscore":'. $result["languagecomplexityscore"]. ',';
                    echo '"Stability":'. $result["stabilityscore"];
                    echo "},";                    
                }
            ?>
        ],
    ...
    <?php
        ...
        foreach($uniquelobs as $lob) {
            $dataByLob = $collection->find(array('LOB' => $lob))->sort(array('portabilityindex' => -1));
            foreach($dataByLob as $data) {        
                $data["Appname"] = str_replace("'","", $data["Appname"]);
                $dataSet[] = array (
                    "Application" => $data["Appname"],
                    "Portability Index" => $data["portabilityindex"],
                    "technical" => $data["cyclomaticscore"],
                    "maintainabilityindex" => $data["maintainabilityindex"],
                    "appsizevalue" => $data["appsizevalue"],
                    "outbound" => $data["outbounds"],
                    "inbound" => $data["inbounds"],
                    "appcriticality" => $data["appcriticality"],
                    "languagecomplexityscore" => $data["languagecomplexityscore"],
